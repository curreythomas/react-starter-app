...
const App = () => {
    return (
        <div className="App">
            ...
            <p>To add components, create a .js file and add it to the components folder. Import the component into App.js. If you have any assets, place those in the assets folder.</p>
